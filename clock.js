...
const timeCount = () => {
  ...
  hours_number[0].innerHTML = (hours > 9 && hours) || "0" + hours;
  minutes_number[0].innerHTML = (minutes > 9 && minutes) || "0" + minutes;
  seconds_number[0].innerHTML = (seconds > 9 && seconds) || "0" + seconds;
  ...
  hours_number[1].innerHTML =
    (hours_France > 9 && hours_France) || "0" + hours_France;
  minutes_number[1].innerHTML =
    (minutes_France > 9 && minutes_France) || "0" + minutes_France;
  seconds_number[1].innerHTML =
    (seconds_France > 9 && seconds_France) || "0" + seconds_France;
  ...
  hours_number[2].innerHTML = (hours_LA > 9 && hours_LA) || "0" + hours_LA;
  minutes_number[2].innerHTML =
    (minutes_LA > 9 && minutes_LA) || "0" + minutes_LA;
  seconds_number[2].innerHTML =
    (seconds_LA > 9 && seconds_LA) || "0" + seconds_LA;
